...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Consultar documento para pago de factura</h3>
    </div>
        ...
        <form id='frm_cliente' role="form" method="post" action="{{ route('bank_list') }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-6  col-md-offset-3">
                        <button class="btn btn-success btn-primary btn-block" type="button" id="cliente_pagar" name="pagar">Consultar</button>
                    </div>
                </div>
